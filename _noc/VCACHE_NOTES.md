...
| frequency | 3.0 GHz base / 1.5 GHz cache, all paths meet; the model found six violations first and the RTL was restructured |
| thermals | `pd/thermal/thermal_model.py` — +3.3 °C stacking penalty, throttle at 16 W, 0.6 ms dielet time constant |
