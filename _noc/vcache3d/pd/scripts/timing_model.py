...
def main():
    ...
    print("      base cycles;")
    print("    * the line ECC runs in parallel with a COMBINATIONAL speculative")
    print("      S5 return; only a non-zero syndrome stalls / replays the access.")
    ...
    print("      bond RX + speculative response       1 base cycle")
    print("    = 1 + 3 + 1 = 4 base cycles (the 3 array cycles subcycle within")
    print("      the 2.2 GHz array ratio, and the response is combinational)")
    print("    --------------------------------------")
    print("    stacked hit (ways 4-15)              16 cycles = 5.33 ns")
    print()
    print("  The stacked region now costs +4 base cycles (+1.33 ns), exactly the")
    print("  published AMD 3D V-Cache latency adder.  This is achieved by the")
    print("  DDR bond link, the macro-sliced 2.2 GHz dielet, and the")
    print("  combinational zero-syndrome speculative return that removes the")
    print("  response-register cycle from the common path.")
    ...
    print("    * 16 cycles is still ~15x faster than the DRAM access it")
